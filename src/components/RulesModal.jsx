...
const WEAPON_TABLE = [
  { name: 'Small Laser',         range: 3,  att: 3, str: 0, slots: 1, special: 'Deadly' },
  { name: 'Medium Laser',        range: 6,  att: 4, str: 1, slots: 2, special: 'Overheating, Deadly' },
  { name: 'Large Laser',         range: 9,  att: 4, str: 2, slots: 3, special: 'Overheating, Deadly' },
  { name: 'Small Pulse Laser',   range: 3,  att: 4, str: 0, slots: 1, special: 'Accurate' },
  { name: 'Medium Pulse Laser',  range: 6,  att: 6, str: 1, slots: 2, special: 'Overheating, Accurate' },
  { name: 'Large Pulse Laser',   range: 9,  att: 6, str: 2, slots: 3, special: 'Overheating, Accurate' },
  { name: 'ER Small Laser',      range: 6,  att: 2, str: 1, slots: 1, special: 'Overheating, Deadly' },
  { name: 'ER Medium Laser',     range: 9,  att: 3, str: 1, slots: 2, special: 'Overheating, Deadly' },
  { name: 'Streak SRM Rack',     range: 3,  att: 3, str: 0, slots: 1, special: 'Ammo Box, Accurate, Deadly' },
  ...
  { name: 'Autocannon/2',        range: 10, att: 2, str: 1, slots: 1, minRange: 2, special: 'Ammo Box, Relentless' },
  { name: 'Autocannon/10',       range: 6,  att: 4, str: 2, slots: 2, special: 'Ammo Box, Relentless' },
  { name: 'Autocannon/20',       range: 4,  att: 6, str: 3, slots: 3, special: 'Ammo Box, Relentless, Deadly' },
  { name: 'Ultra AC/2',          range: 10, att: 3, str: 0, slots: 1, minRange: 1, special: 'Ammo Box, Relentless' },
  { name: 'Ultra AC/5',          range: 9,  att: 6, str: 1, slots: 2, special: 'Ammo Box, Relentless' },
  { name: 'Ultra AC/10',         range: 6,  att: 8, str: 2, slots: 3, special: 'Ammo Box, Relentless' },
  { name: 'LB 2-X AC',          range: 10, att: 3, str: 0, slots: 1, minRange: 2, special: 'Ammo Box, Relentless' },
  { name: 'LB 5-X AC',          range: 9,  att: 6, str: 0, slots: 2, special: 'Ammo Box, Relentless' },
  { name: 'LB 10-X AC',         range: 6,  att: 10,str: 0, slots: 3, special: 'Ammo Box, Relentless' },
  { name: 'Machine Gun Array',   range: 3,  att: 8, str: 0, slots: 1, special: 'Ammo Box, Relentless, Light Arms' },
  { name: 'Arrow IV Artillery',  range: 12, att: 3, str: 2, slots: 3, minRange: 3, special: 'Ammo Box, Indirect, Blast' },
